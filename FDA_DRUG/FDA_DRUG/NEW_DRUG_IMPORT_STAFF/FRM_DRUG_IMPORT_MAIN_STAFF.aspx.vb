...
Public Class FRM_DRUG_IMPORT_MAIN_STAFF
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        RunSession() ' Call funtion ด้านบน    line9
        get_pvncd()     'Call function Line 31
        If Not IsPostBack Then
            load_ddl()      'call function 42
            'load_GV_lcnno()
        End If
    End Sub
    Sub get_pvncd()
        ...
        Try
            _pvncd = Personal_Province_NEW(_CLS.CITIZEN_ID, _CLS.CITIZEN_ID_AUTHORIZE, _CLS.GROUPS) 'get data as integer 
            If _pvncd = 0 Then
                _pvncd = _CLS.PVCODE
            End If
        Catch ex As Exception
    ...
    Private Sub load_ddl()
        ...
        Dim bao As New BAO.ClsDBSqlcommand      ' plug in to database sql

        dt = bao.SP_MAS_NYMSTAFF_PROCESS

        ddl_search.DataSource = dt 'dao.datas             
        ddl_search.DataTextField = "PROCESS_NAME"
        ddl_search.DataValueField = "PROCESS_ID"          'Call name and id from sql 
        ddl_search.DataBind()
        Dim item As New ListItem
        item.Text = "กรุณาเลือกประเภท"                        ' Word in space from dropdown list
        item.Value = "0"
    ...
    End Sub
    Sub load_GV_lcnno()                                     ' อะไรก็ไม่รู้ ไว้ดูอีกที แต่เมื่อก่อนเป็น คอมเม้น
...
#Region "GRIDVIEW"       'function ใน grid view น่าจะยังไม่ได้เชื่อมฐาน ตอนแรกเป็นคอมเม้นทั้งหมด
    ...
    'function ใน grid view น่าจะยังไม่ได้เชื่อมฐาน ตอนแรกเป็นคอมเม้นทั้งหมด
...
#End Region
    ...
    Protected Sub btn_search_Click(sender As Object, e As EventArgs) Handles btn_search.Click
        ...
        End If
    End Sub
    Protected Sub btn_inputbystaff_click(sender As Object, e As EventArgs) Handles btn_inputbystaff 
            ' ต้องมีโค๊ด จากการเลือกประเภท นยม หรือ Token เพื่อส่งไปหาพี่ ICE  
